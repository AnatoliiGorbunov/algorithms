...
import static ru.geekbrains.lesson6.Main.Tree.uniqueRandom;
...
public class Main {
    ...
    public static class Tree {
        ...
        //insert
        public void insert(Cat c) {//вставка//все элементы  кладутся влво < root < кладутся вправо
        ...
        //delete
        public boolean delete(int age) {//снимаем коотв с деревьев
            TreeNode curr = root;
            TreeNode prev = root;
        ...
        public static void uniqueRandom(List<Integer> a, int amount){
        ...
        int isBalanced(TreeNode root){
            ...
            rDepth = isBalanced(root.leftChild);
